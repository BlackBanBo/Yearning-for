<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<head>
		<meta charset="UTF-8">
		<title>Scarica gratis GARAGE Template html/css - Web Garen Morbid - Web Agency</title>
		...
		<div class="allcontain">
			<div class="feturedsection">
				<h1 class="text-center">
					<span class="bdots">&bullet;</span>F E A T U R E S
					<span class="carstxt">C A R S</span>&bullet;
				</h1>
			</div>
								...
								<div class="featurecontant">
									...
									<div id="readmore">
										...
										<p>
											...
											<br> sed do eiusmod tempor incididunt"Lorem ipsum dolor sit amet, consectetur1 , sed do eiusmod tempor incididunt"Lorem
											ipsum dolor sit amet, consectetur1 sed do eiusmod tempor incididunt"Lorem ipsum dolor sit amet, consectetur1
											<br>
										</p>
			...
			<div class="latestcars">
				...
				<ul class="nav nav-tabs navbar-left latest-navleft">
					...
					<li role="presentation">
						<a href="#" class="alphSort">ALPHABETICAL
						</a>
					</li>
			...
			<div class="newslettercontent">
				<div class="leftside">
					...
					<h1>NEWSLETTER</h1>
					<p>
						Subscribe to the COLLECTIONCARS mailing list to
						<br> receive updates on new arrivals, special offers
			...
			<div class="bottommenu">
				...
				<ul class="nav nav-tabs bottomlinks">
					...
					<li role="presentation">
						<a href="#/">RECEIVE OUR NEWSLETTER</a>
					</li>
				</ul>
				<p>
		...
		<script type="text/javascript">
			...
			$.ajax({
				...
				success: function (data) {
					var j=0;
					for(var i = 0; i < data.length; i++){
						if(data[i].type=="suffling"){
							if(j==0){
								image += '<div class="item active">';
								image += '<img src="picture/'+data[i].fileName+'" alt="'+data[i].fileName+'">';
								image += '<div class="carousel-caption">';
								image += '<h2>Car</h2><p>Lorem ipsum dolor sit amet, consectetur ,<br> sed do eiusmod tempor incididunt ut labore</p>';
								image += '</div></div>';
								j++;
							}else{
