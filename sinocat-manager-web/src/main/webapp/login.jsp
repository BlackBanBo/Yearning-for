			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1" style="margin-top: 100px;">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">Sinocat</span>
								<span class="white" id="id-text2">中自催化</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; Sinocat</h4>
						</div>
								...
								<div class="widget-body">
									<div class="widget-main">
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="电话号码" name="u_phone"  value="${cookie.u_phone.value }"/>
														<i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control"
														placeholder="密码" name="u_password" value="${cookie.u_password.value }" /> <i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														class="ace" name="rempwd" value="rempwd" /> <span class="lbl"> 记住</span>
													</label>
										...
										<div class="social-login center">
											<a class="btn btn-primary"> <i style="position:relative;top:9px;"
												class="ace-icon fa fa-qq"></i>
											</a> <a class="btn btn-info" style="background: green !important;"> <i style="position:relative;top:9px;"  
												class="ace-icon fa fa-wechat"></i>
											</a> <a class="btn btn-danger"> <i style="position:relative;top:9px;" 
