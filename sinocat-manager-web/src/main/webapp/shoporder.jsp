...
<script type="text/javascript" src="js/common.js"></script>
	...
	<body>
		...
		<div class="wrap">
			...
			<div class="cart_bg">
				<table id="shopfoot1" width="100%" border="0">
					<tr class="order_img">
				    	<td width="3%"></td>
				        <td width="40%"> 配送方式：</td>
				        <td width="49%">快递 免邮</td>
				        <td width="3%"></td>
				    </tr>
				    <tr class="order_img">
				    	<td width="3%"></td>
				        <td width="40%">运费险：</td>
				        <td width="49%">确认收货前可赔付9元  ￥0.7</td>
				        <td width="10%"> <input type="checkbox" name="check_item" id="check_item"></td>
				        <td width="3%"></td>
				    </tr>
				    <tr class="order_img">
				    	<td width="3%"></td>
				        <td width="40%">运费险投保须知</td>
				        <td width="49%"></td>
				        <td width="3%"></td>
				    </tr>
				    <tr class="order_img">
				...
				<table id="shopfoot2" width="100%" border="0">
				    <tr>
				    	<td width="3%"></td>
				        <td width="49%">
				            <p> <span class="pl15">金额合计：</span><span class="ff6">￥198.00</span></p>
				        </td>
				        <td width="20%"><button class="submit">确认支付</button></td>
				        <td width="3%"></td>
				    </tr>
				</table>
			</div> 
